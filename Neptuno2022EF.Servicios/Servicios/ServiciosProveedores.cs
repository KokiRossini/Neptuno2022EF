...
namespace Neptuno2022EF.Servicios.Servicios
{
    public class ServiciosProveedores:IServiciosProveedores
    {
        ...
        public List<ProveedorListDto> GetProveedorPorPagina(int cantidad, int pagina)
        {
            try
            {
                return _repositorio.GetProveedorPorPagina(cantidad, pagina);
            }
            catch (Exception)
            {
        ...
        public List<ResumenProveedorListDto> GetResumenProveedores()
        {
            try
            {
                return _repositorio.GetResumenProveedores();
            }
            catch (Exception)
            {
        ...
        public List<ProveedorListDto> GetDetalleProveedor(int proveedorId)
        {
