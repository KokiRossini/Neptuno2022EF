...
namespace Neptuno2022EF.Windows
{
    public partial class frmVentas : Form
    {
        ...
        private readonly IServiciosCtaCtes _serviciosCtaCtes;
        private List<VentaListDto> lista;

        public frmVentas(IServiciosVentas servicio, IServiciosCtaCtes serviciosCtaCtes)
        {
            InitializeComponent();

            _servicio = servicio;
            _serviciosCtaCtes = serviciosCtaCtes;
        }
        ...
        {
            frmVentaAE frm = new frmVentaAE(DI.Create<IServiciosClientes>(),DI.Create<IServiciosProductos>(), DI.Create<IServiciosCtaCtes>()) { Text = "Nueva Venta" };
            DialogResult dr = frm.ShowDialog(this);
            ...
            try
            {
                ...
                _serviciosCtaCtes.Agregar(ctaCte);
